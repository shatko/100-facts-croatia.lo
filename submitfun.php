...
/* database stuff */
			...
			$sql = "INSERT INTO crofactsfun (croname,croexplained,crolink,croimages) VALUES ('$_POST[name]','$_POST[explained]','$_POST[link]','$imagename2')";
...
<html>
	...
	<body>
		<form action="submitfun.php" method="post" enctype="multipart/form-data">
