...
<body>
	<table>
		...
		// removes those funny characters 
			...
			$sql = "SELECT * FROM crofactsfun";
			$data = mysqli_query($conn, $sql);

		// deletes a row
			if(isset($_POST['delete'])) {	
				$DeleteQuery = "DELETE FROM crofactsfun WHERE croid='$_POST[hidden]'";
		...
		// display the content
			while ($cell = mysqli_fetch_array($data)){
				echo "<form action=datafun.php method=post>";
				echo '<tr>';
				...
				echo '<td><a href="editfun.php?fact='.$cell['croid'].'">edit</a></td>';
